...
namespace Frankenstein\Resource\MariaDB\TestData\test;

use \Approach\Resource\MariaDB;
use Frankenstein\Resource\MariaDB\Aspect\TestData\test\names\user_trait as aspects;
...
class names extends MariaDB\Table{
	...
	const DATABASE_CLASS = '\Frankenstein\Resource\MariaDB\TestData\test';

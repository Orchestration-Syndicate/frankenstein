...
namespace Frankenstein\Resource\MariaDB\MenuData\test;

use \Approach\Resource\MariaDB;
use Frankenstein\Resource\MariaDB\Aspect\MenuData\test\names\user_trait as aspects;
...
class names extends MariaDB\Table{
	...
	const DATABASE_CLASS = '\Frankenstein\Resource\MariaDB\MenuData\test';
